...
/*
  ...
  ======================================================================*/
		...
		if ($('.careers-side-bar').length > 0) {
			$('.careers-side-bar').on('click', function (e) {
				e.preventDefault();
				e.stopPropagation();
				$('.career-group').addClass('isActive');
			});
		}
		if ($('.close-side-widget').length > 0) {
			$('.close-side-widget').on('click', function (e) {
				e.preventDefault();
				$('.career-group').removeClass('isActive');
			});
		}

		if ($('.case-study-side-bar').length > 0) {
			$('.case-study-side-bar').on('click', function (e) {
				e.preventDefault();
				e.stopPropagation();
				$('.case-study-group').addClass('isActive');
			});
		}
		if ($('.close-side-widget').length > 0) {
			$('.close-side-widget').on('click', function (e) {
				e.preventDefault();
				$('.case-study-group').removeClass('isActive');
			});
		}

		if ($('.download-side-bar').length > 0) {
			$('.download-side-bar').on('click', function (e) {
				e.preventDefault();
				e.stopPropagation();
				$('.download-group').addClass('isActive');
			});
		}
		if ($('.close-side-widget').length > 0) {
			$('.close-side-widget').on('click', function (e) {
				e.preventDefault();
				$('.download-group').removeClass('isActive');
			});
		}

		if ($('.contact-side-bar').length > 0) {
			$('.contact-side-bar').on('click', function (e) {
				e.preventDefault();
				e.stopPropagation();
				$('.contact-group').addClass('isActive');
			});
		}
		if ($('.close-side-widget').length > 0) {
			$('.close-side-widget').on('click', function (e) {
				e.preventDefault();
				$('.contact-group').removeClass('isActive');
			});
		}
